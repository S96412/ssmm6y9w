...
public class ZaixianjuanzengController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZaixianjuanzengEntity zaixianjuanzeng, 
		...
		if(tableName.equals("juanzengfang")) {
			zaixianjuanzeng.setJuanzengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("shouzengfang")) {
			zaixianjuanzeng.setShouzengzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		if(tableName.equals("shouzengfang")) {
			wrapper.eq("shouzengzhanghao", (String)request.getSession().getAttribute("username"));
		}
