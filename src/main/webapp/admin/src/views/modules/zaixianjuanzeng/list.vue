      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <!-- <el-form-item :label="contents.inputTitle == 1 ? '审核状态' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.sfsh" placeholder="审核状态" clearable></el-input>
                ...
                <el-form-item label="">
                  <el-select v-model="searchForm.sfsh" placeholder="审核状态">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="捐赠时间">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="juanzengzhaopian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="捐赠照片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.juanzengzhaopian">
                        <img :src="$base.url+scope.row.juanzengzhaopian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
