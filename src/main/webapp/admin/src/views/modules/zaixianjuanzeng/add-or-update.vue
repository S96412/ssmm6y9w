  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.juanzengzhaopian" label="捐赠照片" prop="juanzengzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.juanzengzhaopian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <!-- <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠姓名" prop="juanzengxingming">
          <el-input v-model="ruleForm.juanzengxingming" 
              placeholder="捐赠姓名" clearable  :readonly="ro.juanzengxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠姓名" prop="juanzengxingming">
              <el-input v-model="ruleForm.juanzengxingming" 
                placeholder="捐赠姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="受赠账号" prop="shouzengzhanghao">
          <el-input v-model="ruleForm.shouzengzhanghao" 
              placeholder="受赠账号" clearable  :readonly="ro.shouzengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="受赠账号" prop="shouzengzhanghao">
              <el-input v-model="ruleForm.shouzengzhanghao" 
                placeholder="受赠账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="受赠姓名" prop="shouzengxingming">
          <el-input v-model="ruleForm.shouzengxingming" 
              placeholder="受赠姓名" clearable  :readonly="ro.shouzengxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="受赠姓名" prop="shouzengxingming">
              <el-input v-model="ruleForm.shouzengxingming" 
                placeholder="受赠姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
             <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地址" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi" 
              placeholder="地址" clearable  :readonly="ro.lianxifangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地址" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
            ...
            <!-- <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="地址" prop="juanzenglaiyuan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.juanzenglaiyuan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.juanzenglaiyuan" label="捐赠来源" prop="juanzenglaiyuan">
                    <span v-html="ruleForm.juanzenglaiyuan"></span>
                </el-form-item>
              </div>
            </el-col> -->
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.juanzengshuliang = true;
          ...
          if(o=='juanzenglaiyuan'){
            this.ruleForm.juanzenglaiyuan = obj[o];
	    this.ro.juanzenglaiyuan = true;
            continue;
          }
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='shouzengzhanghao'){
            this.ruleForm.shouzengzhanghao = obj[o];
	    this.ro.shouzengzhanghao = true;
            continue;
          }
          if(o=='shouzengxingming'){
            this.ruleForm.shouzengxingming = obj[o];
	    this.ro.shouzengxingming = true;
            continue;
          }
          if(o=='lianxifangshi'){
	...
	this.ruleForm.juanzenglaiyuan = this.ruleForm.juanzenglaiyuan.replace(reg,'../../../ssmm6y9w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
