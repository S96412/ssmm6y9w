      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <!-- <el-form-item :label="contents.inputTitle == 1 ? '受赠姓名' : ''">
                  ...
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.shouzengxingming" placeholder="受赠姓名" clearable></el-input>
                </el-form-item> -->
		<el-form-item class="select" label="" prop="sfsh">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="标题">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="zhengming"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="需求照片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.zhengming">
                        <img :src="$base.url+scope.row.zhengming.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('xuqiuxinxi','在线捐赠') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zaixianjuanzengCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'在线捐赠':'' }}</el-button>
                <el-button v-if="isAuth('xuqiuxinxi','在线捐赠') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zaixianjuanzengCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'在线捐赠':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuqiuxinxi','在线捐赠') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zaixianjuanzengCrossAddOrUpdateHandler(scope.row,'cross','是','','')">{{ contents.tableBtnFont == 1?'在线捐赠':'' }}</el-button>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          xuqiuyongtu: row.xuqiuyongtu,
          dizhi: row.dizhi,
          xiangxishuoming: row.xiangxishuoming,
          fabushijian: row.fabushijian,
          shouzengzhanghao: row.shouzengzhanghao,
          shouzengxingming: row.shouzengxingming,
